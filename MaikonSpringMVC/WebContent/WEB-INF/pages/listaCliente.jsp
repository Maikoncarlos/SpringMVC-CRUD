      ...
      <th scope="col">Ações</th>
		 	...
		 	<c:forEach var="listValue" items="${clientes}"> 
					...
					<tr>
						...
						<td><a  class="btn btn-danger" role="button" href="deletar/${listValue.cpf}">Deletar</a>&nbsp; &nbsp;
							<a class="btn btn-primary" role="button" href="alterar/${listValue.cpf}">Editar</a>&nbsp; &nbsp;</td>
					</tr>
			...
			<table class="table table-bordered">
				...
				<td><a class ="btn btn-dark" href="cliente" role="button">Novo Cliente</a>&nbsp; &nbsp;
				 <a class ="btn btn-dark" href="paginaInicial" role="button">Pagina Inicial</a>&nbsp; &nbsp;</td>
			</tr>
		</table>
	</center>
</body>
